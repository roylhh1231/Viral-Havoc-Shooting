...
public class doorWithbattery : MonoBehaviour, IInteractable
{
    ...
    //[SerializeField] private GameObject Light; // Reference to the AccessCard GameObject
    ...
    {
        if (ReactorWithAccess.instance.light)
        {
        ...
        else
        {
            ...
            if (promptUI != null)
            {
                promptUI.Setup("Electricity needed");
